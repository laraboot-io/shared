...
[![GitHub Release](https://img.shields.io/github/v/release/laraboot-io/shared)](https://github.com/laraboot-io/shared/releases)
[![Go Reference](https://pkg.go.dev/badge/github.com/laraboot-io/shared.svg)](https://pkg.go.dev/github.com/laraboot-io/shared)
[![go.mod](https://img.shields.io/github/go-mod/go-version/laraboot-io/shared)](go.mod)
[![LICENSE](https://img.shields.io/github/license/laraboot-io/shared)](LICENSE)
[![Build Status](https://img.shields.io/github/workflow/status/laraboot-io/shared/build)](https://github.com/laraboot-io/shared/actions?query=workflow%3Abuild+branch%3Amain)
[![Go Report Card](https://goreportcard.com/badge/github.com/laraboot-io/shared)](https://goreportcard.com/report/github.com/laraboot-io/shared)
[![Codecov](https://codecov.io/gh/laraboot-io/shared/branch/main/graph/badge.svg)](https://codecov.io/gh/laraboot-io/shared)
...
1. Replace all occurences of `laraboot-io/shared` to `your_org/repo_name` in all files.
